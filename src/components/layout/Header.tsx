...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="hidden md:flex h-16 border-b border-stone-200 dark:border-stone-800 px-6 lg:px-8 items-center justify-between bg-white/80 dark:bg-stone-900/80 backdrop-blur-md sticky top-0 z-30 transition-colors">
